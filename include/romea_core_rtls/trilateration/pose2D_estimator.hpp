...
#ifndef ROMEA_CORE_RTLS__TRILATERATION__POSE2D_ESTIMATOR_HPP_
#define ROMEA_CORE_RTLS__TRILATERATION__POSE2D_ESTIMATOR_HPP_
...
private:
  ...
  std::vector<std::vector<size_t>> indexes_of_available_ranges_;
};

}  // namespace core
}  // namespace romea

#endif  // ROMEA_CORE_RTLS__TRILATERATION__POSE2D_ESTIMATOR_HPP_
