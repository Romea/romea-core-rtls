...
void serialize_cartesian_coordinate(const double& cartesian_coordinate,
                                    unsigned char* buffer);

void deserialize_cartesian_coordinate(const unsigned char* buffer,
                                      double& cartesian_coordinate);

void serialize_wgs84_coordinate(double& wgs84_coordinate,
                                unsigned char* buffer);

void deserialize_wgs84_coordinate(const unsigned char* buffer,
                                  double& wgs84_coordinate);
...
void deserialize_position2d_covariance(
    ...
    Eigen::Ref<Eigen::Matrix2d> position_covariance);

void serialize_position2d_covariance(
    const Eigen::Ref<const Eigen::Matrix2d>& position_covariance,
    unsigned char* buffer);
...
void serialize_orientation_variance(const double& orientation_covariance,
                                    unsigned char* buffer);
