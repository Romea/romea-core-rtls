...
#ifndef ROMEA_CORE_RTLS__SCHEDULING__NEARBY_TRANSCEIVER_FINDER_HPP_
#define ROMEA_CORE_RTLS__SCHEDULING__NEARBY_TRANSCEIVER_FINDER_HPP_
...
class RTLSNearbyTransceiverFinder {
 ...
 private:
  ...
  std::vector<size_t> neighbor_indexes_;
  std::vector<double> neighbor_square_distances_;
};

}  // namespace core
}  // namespace romea

#endif  // ROMEA_CORE_RTLS__SCHEDULING__NEARBY_TRANSCEIVER_FINDER_HPP_
