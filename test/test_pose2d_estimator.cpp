...
TEST(TestRtlsPoseEstimator, testRtlsPoseEstimator)
{
  ...
  romea::core::VectorOfEigenVector3d tag_positions;
  tag_positions.emplace_back(0, -0.3, 1.01);
  tag_positions.emplace_back(0, 0.3, 1.01);
  tag_positions.emplace_back(0.44, 0, 0.71);

  romea::core::VectorOfEigenVector3d anchor_positions;
